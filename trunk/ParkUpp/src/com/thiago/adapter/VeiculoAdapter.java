...
public class VeiculoAdapter  extends BaseAdapter {
	...
	private List<VeiculoPU> historico;

	private Context contexto;
	
	public VeiculoAdapter(List<VeiculoPU> historico, Context contexto) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		textViewItem.setText(historico.get(position).getNome());
		
		TextView textViewItem2 = (TextView) convertView.findViewById(android.R.id.text2);
		textViewItem2.setText(historico.get(position).isCarro()?"Carro":"Moto");
